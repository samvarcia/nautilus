      ...
      <div className={styles.page}>
        <div className={styles.manifestoContent}>
          ...
          <div className={styles.firstParagraph}>
            ...
            <Image src="/manifesto1.png" alt="School has stolen your childhood" width={500} height={660} className={styles.desktopImage} />
          </div>
          <div className={styles.secondParagraph}>
            <Image src="/manifesto2.png" alt="School has stolen your childhood" width={500} height={660} className={styles.desktopImage} />
            <div className={styles.text}>
              <h2 className={styles.paraSub}>Becoming an adult doesn't make it easier</h2>
              <Image src="/manifesto2.png" alt="School has stolen your childhood" width={500} height={660} className={styles.mobileImage} />
          ...
          <div className={styles.fourthParagraph}>
            <div className={styles.text}>
              ...
              <Image src="/manifesto4.png" alt="School has stolen your childhood" width={500} height={660} className={styles.mobileImage} />
            ...
            <Image src="/manifesto4.png" alt="School has stolen your childhood" width={500} height={660} className={styles.desktopImage} />
          </div>
        </div>
        <Footer />
      </div>
